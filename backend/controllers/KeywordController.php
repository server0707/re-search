...
use common\models\search\KeywordSearch;
...
class KeywordController extends Controller
{
    ...
    {
        if (($model = Keyword::findOne(['id' => $id])) !== null) {
            return $model;
        }
    ...
    public function actionSearch($query = null)
    {
        ...
        foreach (Keyword::find()->where(['like', 'name', $query])->asArray()->all() as $keyword) {
            $items[] = ['name' => $keyword['name']];
        }
        return $items;
    }
}
