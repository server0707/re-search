    ...
    <div class="row">
        <a href="<?= \yii\helpers\Url::to(['/contacts']) ?>" class="col-lg-6 border border-dark"
           style="border-radius: 15px">
            ...
            <hr>
            <p class="text-center">
                Sizda <?= ($newContactsCount > 0) ? "ta yangi aloqa habari mavjud." : "yangi aloqa habari mavjud emas." ?></p>
        </a>
        <a href="<?= \yii\helpers\Url::to(['/interactive-services']) ?>" class="col-lg-6 border border-dark"
           style="border-radius: 15px">
            ...
            <hr>
            <p class="text-center">
                Sizda <?= ($newInteractiveServicesCount > 0) ? "ta yangi interaktiv xizmatlar habari mavjud." : "yangi interaktiv xizmatlar habari mavjud emas." ?></p>
        </a>
    </div>
</div>